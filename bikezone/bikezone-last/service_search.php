...
if(isset($_SESSION['service_search'])){
...
$filterQuery = $filterQuery1." UNION ".$filterQuery2;
    ...
    $_SESSION['service_search'] = $filterQuery;
    $_SESSION['service_search_business'] = $filterQuery2;
  ...
  ?>
    ...
    <div class="col-md-2 no-padding photobox">
        <div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span>
         <a href="used_bikes_view.php?filename=service_search&usedbikeid=<?php echo $row['UsedBikeId']; ?> &userid=<?php echo $row['UserId']; ?> &brand=<?php echo $row['Brand']; ?> &category=<?php echo $row['BikeCategory']; ?>" role="button">
...
?>
    ...
    <div class="col-sm-7 add-desc-box">
        <div class="ads-details">
            <h5 class="add-title"><a href="used_bikes_view.php?filename=service_search&usedbikeid=<?php echo $row['UsedBikeId']; ?> &userid=<?php echo $row['UserId']; ?> &brand=<?php echo $row['Brand']; ?> &category=<?php echo $row['BikeCategory']; ?>" role="button">
...
<div class="pagination-bar text-center">
  ...
  <ul class="pagination" id="pagination" >
    <?php if(!empty($total_pages)):for($i=1; $i<=$total_pages; $i++):  
     if($i == 1):?>
      <li class="page-item active"  id="<?php echo $i;?>"><a class="page-link" href='pagination_service_search.php?page=<?php echo $i;?>'><?php echo $i;?></a></li> 
      <?php else:?>

       <li class="page-item" id="<?php echo $i;?>"><a href='pagination_service_search.php?page=<?php echo $i;?>'><?php echo $i;?></a></li>
...
$('.pagination').pagination({
        ...
        onPageClick : function(pageNumber) {
            ...
            jQuery("#target-content").load("pagination_service_search.php?page=" + pageNumber);
        }
    });
});
</script> 
...
function recp() {
  ...
  $('#myStyle').load('fetch_data_service_search.php?category=' + encodeURIComponent(category) + '&city=' + encodeURIComponent(city)+ '&minPrice=' + min+ '&maxPrice=' + max);
...
function sort_by(value){
  ...
  jQuery('#masterdiv div').hide();
   //jQuery('#pagination').hide();
  $('#target-content').load('fetch_sorting_service_search.php?value=' + encodeURIComponent(value));
}
