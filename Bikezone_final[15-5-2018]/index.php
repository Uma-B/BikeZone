...
.dropdown:hover .dropdown-content {
   ...
   <!--themeControll--> <div class="header">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-left">
                      ...
                      <li><a href="">Insurance</a></li>
                       <li class="dropdown no-arrow nav-item" style="margin-top: 3px;"><a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">Service</a>
                          <ul
        ...
        <div class="container">
            ...
            <div class="col-xl-12 content-box ">
                <div class="row row-featured row-featured-category">
                    ...
                    <div class="col-xl-4 col-md-4 col-sm-4 col-xs-4 f-category">
                        <a href="used_bikes.php"><img src="images/category/sample_bike.jpg" class="img-responsive" alt="img"> <h6> Used Bikes </h6></a>
                    </div>
