...
<div id="wrapper">
    ...
    <div class="col-md-2 no-padding photobox">
        <div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span><a href="fullview.php?id=<?php echo $row['UsedBikeId']; ?>" role="button">
...
$sql=mysql_query("select UsedBikeImage1, Brand, Model, KilometreDriven, Location, UserName, ContactNumber, Prize from usedbikes where Brand LIKE '$Brand' OR Model LIKE '$Model' OR City LIKE '$City'");
...
<div class="item-list">
    ...
    <div class="col-md-2 no-padding photobox">
        <div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> 2 </span>
         <a href="view.php?id=<?php echo $row['UsedBikeId'];  ?> &Userid=<?php echo $res['UserId']; ?> &Category=<?php echo $res['BikeCategory']; ?>" role="button">
