...
if(isset($_SESSION['fetchToPagination'])){
   ...
   $filter2=$_SESSION['service_search_business'];
    $filter1=$_SESSION['service_search_personal'];
}
  ...
  <div id="masterdiv">
      ...
      <div class="tab-box  oldList">
                            ...
                            <ul class="nav nav-tabs add-tabs" id="ajaxTabs" role="tablist">
                                ...
                                <li class="nav-item ">
                                    <a  href="service_search_buisness.php" class= "nav-link" role="tab" >Business Ads 
                                    <span class="badge badge-secondary" style="display:inline-block">
                                          <?php
