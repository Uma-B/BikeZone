...
<!-- <div id="wrapper">
    ...
    <!-- /.header --> -->
        ...
        <div class="search-row-wrapper">
        	<div class="container ">
                <form action="used_bikes.php" method="post">
                    <div class="row">


                        <div class="col-md-3">
                            <input class="form-control keyword" name="Keyword" type="text" placeholder="e.g. Mobile Sale">
                        </div>
                        ...
                        <div class="col-md-2">
                            <select class="form-control selecter" name="City" id="id-location">
                        ...
                        <div class="col-md-3">
                             <input class="btn btn-block btn-primary" class="fa fa-search" type="submit" name="BtnSubmit" value="Find">
                            </button>
                        </div>
                    </div>
                </form>
                ...
                <div class="col-md-9 page-content col-thin-left">
                    <div class="category-list">
                        ...
                        <div class="listing-filter">
                            ...
                            weded3e
                            <select class="form-control selecter" name="Brand" id="search-category"  onchange="fetch_select(this.value);">
                            ...
                            <select class="form-control selecter" name="Model" id="new_select">
...
include 'db_connection.php';
 ...
 $sql=mysql_query("select usedbikes.UsedBikeImage1 as UsedBikeImage1, usedbikes.Brand as Brand, usedbikes.Model as Model, usedbikes.KilometreDriven as KilometreDriven, usedbikes.Location as Location, usedbikes.UserName as UserName, usedbikes.ContactNumber as ContactNumber, usedbikes.Prize as Prize from usedbikes where usedbikes.BikeCategory LIKE '$BikeCategory' OR usedbikes.Brand LIKE '$Brand' OR usedbikes.Model LIKE '$Model' OR usedbikes.State LIKE '$State' OR usedbikes.City LIKE '$City' UNION select dealerbikes.DealerBikeImage1 as BikeImage1, dealerbikes.Brand as Brand, dealerbikes.Model as Model, dealerbikes.KilometreDriven as KilometreDriven, dealerbikes.Location as Location, dealerbikes.UserName as UserName, dealerbikes.ContactNumber as ContactNumber, dealerbikes.Prize as Prize from dealerbikes where dealerbikes.BikeCategory LIKE '$BikeCategory' OR dealerbikes.Brand LIKE '$Brand' OR dealerbikes.Model LIKE '$Model' OR dealerbikes.State LIKE '$State' OR dealerbikes.City LIKE '$City'");
