                  ...
                  <div class="navbar-collapse collapse">
                     ...
                     <ul class="nav navbar-nav ml-auto navbar-right">
                        ...
                        <li class="dropdown no-arrow nav-item">
                           ...
                           <ul
                              class="dropdown-menu user-menu dropdown-menu-right">
                              <li class="dropdown-item"><a href="favourite_view.php"><i class=" icon-money "></i> Favourite Ads </a>
                              </li>
                                 ...
                                 <div class="col-sm-7 add-desc-box">
                                    <div class="ads-details">
                                       <h5 class="add-title"><a href="ads-details.html">
                                          <?php echo $row['Brand'].'-'.$row['Model'] ;  ?></a>
                                       </h5>
                                       <span class="info-row"> 
                                       ...
                                       Contact No : 
                                       </i><?php echo $row['ContactNumber'] ?></span> </span>
                                    </div>
                                 </div>
                                 <!--/.add-desc-box-->
