...
<div id="wrapper">
    ...
    <!-- /.header -->
        ...
        <div class="search-row-wrapper">
            <div class="container ">
                <form action="used_bikes_details.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <select class="form-control selecter" name="Brand" id="search-category"  onchange="fetch_select(this.value);">
                                 ...
                                 $select=mysql_query("SELECT Brand FROM usedbikes");
                        ...
                        <div class="col-md-2">
                            <select class="form-control selecter" name="Model" id="search-category">
                                <option> Select Model</option>
                                 <?php
                                
                                 $select=mysql_query("SELECT Model FROM usedbikes");
                                 while($row=mysql_fetch_array($select))
                                 {
                        ...
                        <div class="col-md-2">
                            <select class="form-control selecter" name="City" id="id-location">
                                <option> Select City</option>
                                 ...
                                 $select=mysql_query("SELECT City FROM usedbikes group by City");
                                 while($row=mysql_fetch_array($select))
                                 {
                        ...
                        <div class="col-md-2">
                            <input class="form-control keyword" name="Prize_Minimum" type="text" placeholder="Prize minimum">
                        </div>
                        <div class="col-md-2">
                            <input class="form-control keyword" name="Prize_Maximum" type="text" placeholder="Prize maximum">
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="inner-box">
                            ...
                            <div class="locations-list  list-filter">
                                <!--<h5 class="list-title"><strong><a href="#">Price range</a></strong></h5>
                                 ...
                                 <form method="post" action="used_bikes_details.php">
                                    <div class="form-group col-lg-4 col-md-12 no-padding">
                                        <input type="text" name="Prize_Minimum" placeholder="minimum" id="minPrice" class="form-control">
                                    </div>
                                    <div class="form-group col-lg-1 col-md-12 no-padding text-center hidden-md"> -</div>
                                    <div class="form-group col-lg-4 col-md-12 no-padding">
                                        <input type="text" name="Prize_Maximum" placeholder="maximimum" id="maxPrice" class="form-control">
                                    </div>
                                    <div class="form-group col-lg-3 col-md-12 no-padding">
                                          <input class="btn btn-block btn-primary" class="fa fa-search" type="submit" name="BtnSubmit" value="">
                                    </div>
                                </form> -->
