                    ...
                    <aside>
                        <div class="inner-box">
                            ...
                            <div class="locations-list  list-filter">
                                ...
                                <ul class="browse-list list-unstyled long-list">
                                    <li><a href="Advance_Search_Find.php"><strong>All Ads</strong> <span
                                            class="count"><?php
...
function recp() {
  ...
  $('#myStyle').load('fetch_data_advance_search_find.php?category=' + encodeURIComponent(category) + '&city=' + encodeURIComponent(city)+ '&minPrice=' + min+ '&maxPrice=' + max);
