            ...
            $BikeCategory = $_GET['category'];
             ...
             $show=mysql_query("select
                ...
                select
                 ...
                 $select=mysql_query("Select DealerType, CompanyName, CompanyEmail, CompanyMobileNum, State, City, Location, PostalCode from dealerregistration WHERE DealerId='$userid'");
...
<div id="wrapper">
            ...
            <div class="row">
                <div class="col-md-9 page-content col-thin-right">
                    <div class="inner inner-box ads-details-wrapper">
                        ...
                        </h2><span class="info-row">
                         <?php
                                  if($res['KilometreDriven']!="0"){
                                   
                              ?>
                                <span class="date"><i class=" icon-clock"> </i>KM's Driven <?php echo $res['KilometreDriven'];?></span> -- 
                                <?php
                              }
                                ?>
                         <span class="item-location"><i
                                class="fa fa-map-marker"></i> State -  <?php echo $res['State'];?></span> </span>
  ...
  ?>
    <h3><b>Company Details </b></h3>
                                    <ul>
                                       <li><b>Dealer type </b> <?php echo $row['DealerType']; ?></li>
                                        <li><b>Company name </b> <?php echo $row['CompanyName']; ?></li>
                                        <li><b>Company email </b> <?php echo $row['CompanyEmail']; ?></li>
                                        <li><b>Company mobile number </b> <?php echo $row['CompanyMobileNum']; ?></li>
                                        <li><b>Location </b> <?php echo $row['Location']; ?></li>
                                        <li><b>City </b><?php echo $row['City']; ?></li>
                                        <li><b>State </b><?php echo $row['State']; ?></li>
                                        <li><b>Postal Code </b><?php echo $row['PostalCode']; ?></li>
                                    </ul>
    <?php
  }
    ?>
