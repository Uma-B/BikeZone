                    ...
                    <div class="category-list">
                        <div class="tab-box " >
                            ...
                            <ul class="nav nav-tabs add-tabs" id="ajaxTabs" role="tablist">
                                ...
                                <li class="nav-item"><a class=" active nav-link"  href="index_find.php" role="tab" data-toggle="tab">Business
...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
  ...
  // city
function recp(city) {
  $('#myStyle').load('fetch_data_business.php?city=' + city);
}
//category
