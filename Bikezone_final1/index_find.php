                            ...
                            <div class="categories-list  list-filter">
                                ...
                                <ul class=" list-unstyled">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <li>                                        
                                       <select onchange="recp('<?php echo $row['BikeCategory']?>')">
                            ...
                            <ul class="nav nav-tabs add-tabs" id="ajaxTabs" role="tablist">
                                <li class="active nav-item">
                                    <a  class="nav-link" href="ajax/ee.html" data-url="ajax/33.html" role="tab"
                                                      data-toggle="tab">All Ads <span class="badge badge-secondary"><?php
...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
  ...
  // city
function recp(city,category) {
  $('#myStyle').load('fetch_data.php?city=' + city + '&category=' +category);
}
//category
