                                        ...
                                        <div class="col-sm-8">
                                            <select name="BikeCategory" id="category-group" class="form-control">
                                                <option value="0" selected="selected"> Select a category...</option>
                                                  <option value="Cars"> New Bikes</option>
                                                <option value="Commercial vehicles"> Old Bikes</option>
                                                <option value="Motorcycles"> Scooter</option>
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="Transmission" id="Select3" class="form-control">
                                                <option value="0" selected="selected"> Select Fuel Type...</option>
                                                  <option value="Cars"> Manual</option>
                                                <option value="Commercial vehicles"> Automatic</option>
                                        ...
                                        <div class="col-sm-8">
                                            <select name="FuelType" id="Select4" class="form-control">
                                                <option value="0" selected="selected"> Select Fuel Type...</option>
                                                  <option value="Cars"> Petrol</option>
                                                <option value="Commercial vehicles"> Diesel</option>
                                        ...
                                        <div class="col-sm-8">
                                            <select name="Stroke" id="Select5" class="form-control">
                                                <option value="0" selected="selected"> Select Stroke Type...</option>
                                                  <option value="Cars"> Two Stroke</option>
                                                <option value="Commercial vehicles"> 4 Stroke</option>
