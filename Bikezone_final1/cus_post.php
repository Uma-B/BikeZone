...
echo $blockStatus;
 ...
 <td><?php 
              ...
              <td>
              <a href="cus_post1.php?id=<?php echo $res['UsedBikeId']; ?> &age=<?php echo $blockStatus  ?> &a=<?php echo $items;  ?>">
              <input type="button" name="Block1" value="<?php echo $blockStatus ?>">
              <!-- <script>alert("<?php echo $blockStatus?>")</script> -->
            </a>
            </td>
