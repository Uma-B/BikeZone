...
<!--    <div class="row"> 
  ...
  <div class="jumbotron">
   ...
   <h2 style="color:#000080;font-family :forte;text-align:center" >Dealer Details</h2><br /><br />
    ...
    <table class="table" style="background-color: #fff;">
      ...
      <?php
        $show=mysql_query("SELECT * FROM dealerregistration");
        while($res=mysql_fetch_array($show)) {
          ?>
          <tr>
            <td><?php echo $res['DealerName'];?></td>
            <td><?php echo $res['EmailID'];?></td>
            <td><?php echo $res['MobileNumber'];?></td>
            <td><?php echo $res['DealerType'];?></td>
            ...
            <td><a href="deal_post.php?DealerId=<?php echo $res['DealerId']; ?>">View</a></td>
            <td><a href="delete.php?id=<?php echo $res['id']; ?>" onClick = "return confirm('are u sure want to delete this record?')">Block</a></td>
          </tr>
          <?php
        }
      ?>
