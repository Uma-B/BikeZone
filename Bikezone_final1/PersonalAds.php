                    ...
                    <div class="category-list">
                        <div class="tab-box " >
                            ...
                            <ul class="nav nav-tabs add-tabs" id="ajaxTabs" role="tablist">
                                ...
                                <li class="nav-item"><a class=" nav-link"  href="index_find.php" role="tab" data-toggle="tab">Business
                                    <span class="badge badge-secondary">22,805</span></a></li>
                                <li class="nav-item"><a class=" active nav-link"  href="ajax/33.html" data-url="ajax/33.html" role="tab" data-toggle="tab">Personal
...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
  ...
  // city
function recp(city) {
  $('#myStyle').load('fetch_data_personal.php?city=' + city);
}
//category
